...
describe('Quiz Score', () => {
  ...
  test('isPassed geeft false bij lager dan 60%', () => {
    ...
    expect(isPassed(wrongAnswers)).toBe(false); // Deze test faalt! Vervang met je eigen test
  });
  ...
  test('getGrade geeft Excellent bij 90%+', () => {
    ...
    expect(getGrade(excellentAnswers)).toBe('Excellent'); // Deze test faalt! Vervang met je eigen test
  });
